...
<img src="{{ '/assets/images/I0b.jpg' | relative_url }}" alt="Explanation" width="600" />

Part B:

<img src="{{ '/assets/images/I1.jpg' | relative_url }}" alt="Macademia Nutcracker with linear actuator that works" width="600" />
